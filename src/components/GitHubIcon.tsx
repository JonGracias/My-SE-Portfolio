...
export default function GitHubIcon({ className = "w-10 h-10" }) {
  return (
    <svg
    ...
    >
      <path d="M12 .297c-6.63 0-12 5.373-12 12 
        ...
        .108-.776.417-1.305.76-1.604-2.665-.304-5.466-1.334-5.466-5.93 
        0-1.31.465-2.381 1.235-3.221-.135-.303-.54-1.523.105-3.176 
        0 0 1.005-.322 3.3 1.23a11.52 11.52 0 0 1 3.003-.404 
        c1.018.005 2.045.138 3.003.404 2.28-1.552 3.285-1.23 
